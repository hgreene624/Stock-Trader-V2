...
from models.adaptive_regime_switcher_v4 import AdaptiveRegimeSwitcher_v4
...
class BacktestAnalyzer:
    ...
    def instantiate_model(self, model_name: str, parameters: Dict[str, Any]):
        ...
        elif model_name == "AdaptiveRegimeSwitcher_v4":
            return AdaptiveRegimeSwitcher_v4(**parameters)
