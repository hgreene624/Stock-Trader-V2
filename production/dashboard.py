...
def main():
    ...
    if accounts_path.exists():
        ...
        if not account_name:
            # Use shared display function from account_selector
            from production.runner.account_selector import display_accounts_from_config
            display_accounts_from_config(accounts)
