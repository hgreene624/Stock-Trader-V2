...
class SectorRotationConsistent_v1(BaseModel):
    """
    ...
    def __init__(
        self,
        model_id: str = "SectorRotationConsistent_v1",
    ...
    def detect_market_regime(self, context: Context) -> str:
        """
        Detect market regime with 4 states: steady_bull, volatile_bull, bear, concentrated.
        """
        ...
        if current_price < sma_200 and sma_50 < sma_200:
            ...
            return 'volatile_bull'  # Transitional = treat as volatile
    ...
    def get_adaptive_parameters(self, context: Context) -> Dict:
        ...
        regime_params = {
            ...
            'bear': {
                ...
                'leverage': 0.5,          # Reduce exposure significantly
